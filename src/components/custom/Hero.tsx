  ...
  return (
    <Section className="grid grid-rows-1 ">
      <div className="flex flex-col lg:flex-row justify-between items-center">
        <div className="font-custom w-full text-custom-db text-[4rem] md:text-[6em] lg:text-[8rem] text-left tracking-wider">
          Architect Your
        </div>
        <Image
          src={image1}
        ...
        <div className="lg:flex-1 justify-between">
          <div className="flex flex-col justify-between h-full">
            ...
            <span className="text-base text-justify">
              Signet Estate Group transforms complex development challenges into
              collaborative opportunities through a creative, flexible, and
              customized approach.
            </span>
